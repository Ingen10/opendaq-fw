...
void DStream::Start()
{
    if((Channel1.dctype >= STREAM_TYPE) ||
            (Channel2.dctype >= STREAM_TYPE) ||
            (Channel3.dctype >= STREAM_TYPE) ||
            (Channel4.dctype >= STREAM_TYPE) ) {
        TCNT2 = 0;
        TIMSK2 = _BV(OCIE2A);
    }

    if( (Channel1.dctype == EXTERNAL_TYPE) ||
            (Channel2.dctype == EXTERNAL_TYPE) ||
            (Channel3.dctype == EXTERNAL_TYPE) ||
            (Channel4.dctype == EXTERNAL_TYPE) ) {
